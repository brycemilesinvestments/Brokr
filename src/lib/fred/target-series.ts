...
export const FRED_TARGET_SERIES: FredSeriesTarget[] = [
  ...
  { id: "RSXFS", category: "Consumer", description: "Retail sales excluding food services" },
